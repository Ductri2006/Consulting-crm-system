          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-[1fr_auto]">
            <div>
              ...
              <h2 className="mt-4 max-w-3xl text-3xl font-bold tracking-tight sm:text-4xl">
                Have a complex decision ahead? Let&apos;s make the next step
                clear.
              </h2>
              <p className="mt-4 max-w-2xl leading-7 text-blue-100">
                Tell us what you are working through. We will help frame the
                challenge and identify the right advisory path.
              </p>
            </div>
            <Link
              to="/consultation"
